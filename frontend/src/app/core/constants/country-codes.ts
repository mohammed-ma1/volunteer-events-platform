/**
 * Country dial codes for the checkout phone input. `iso` is ISO 3166-1 alpha-2,
 * `dial` is the E.164 calling code (without +). The flag emoji is derived from
 * the ISO code via regional-indicator symbols, so we don't store flag glyphs.
 */
...
/** Regional-indicator flag emoji from a 2-letter ISO code (e.g. "KW" -> 🇰🇼). */
...
/** Default country for the checkout phone input. */
export const DEFAULT_COUNTRY_ISO = 'KW';

/** Sorted A–Z by name. Comprehensive worldwide list. */
