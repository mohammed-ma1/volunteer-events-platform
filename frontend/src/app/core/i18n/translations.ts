...
export const TRANSLATIONS: Record<Locale, Record<TranslationKey, string>> = {
  ar: {
    ...
    'hero.body':
      'منصة تقدّم ورشاً وفعاليات مصممة لتعزيز مهاراتك واستعدادك لسوق العمل، مع تجربة تسجيل بسيطة وآمنة.',
    'hero.ctaBrowse': 'تصفح الورش المتاحة',
    'hero.ctaPaths': 'تعرف على المسارات',
    'hero.stat': '+50 ورشة معتمدة',
    'hero.imageAlt': 'طلاب يعملون معاً حول طاولة',
    'feat1.title': 'شهادات معتمدة',
    'feat1.desc': 'برامج موثقة تدعم مسارك الأكاديمي والمهني.',
    'feat2.title': 'محتوى عملي',
    'feat2.desc': 'ورش تطبيقية تركز على المهارات المطلوبة اليوم.',
    'feat3.title': 'مجتمع طلابي',
    'feat3.desc': 'تواصل مع زملائك وخبراء المجال في فعاليات جماعية.',
    'feat4.title': 'مسارات واضحة',
    'feat4.desc': 'اختر المسار المناسب لأهدافك المهنية خطوة بخطوة.',
    'workshops.title': 'أحدث الورش التدريبية',
    'workshops.subtitle': 'اختر من بين مجموعة متنوعة من البرامج لتطوير مهاراتك',
    ...
    'workshops.demoHint': 'هذه ورشة تجريبية. صِل الخادم لإتمام التسجيل.',
    ...
    'faq.a4': 'تختلف حسب الورشة؛ التفاصيل مذكورة في صفحة كل برنامج.',
    'footer.brand':
  ...
  en: {
    ...
    'hero.body':
      'Workshops and activities designed to strengthen your skills and employability—with a simple, secure registration flow.',
    'hero.ctaBrowse': 'Browse workshops',
    'hero.ctaPaths': 'Explore learning paths',
    'hero.stat': '50+ certified workshops',
    'hero.imageAlt': 'Students collaborating at a table',
    'feat1.title': 'Recognized certificates',
    'feat1.desc': 'Credentialed programs that support your academic and career journey.',
    'feat2.title': 'Hands-on learning',
    'feat2.desc': 'Practical sessions focused on skills that matter today.',
    'feat3.title': 'Student community',
    'feat3.desc': 'Connect with peers and mentors in group experiences.',
    'feat4.title': 'Clear pathways',
    'feat4.desc': 'Choose tracks that match your goals, step by step.',
    'workshops.title': 'Latest training workshops',
    'workshops.subtitle': 'Choose from a variety of programs to develop your skills',
    ...
    'workshops.demoHint': 'Demo workshop—connect the API to complete registration.',
    ...
    'faq.a4': 'It depends on the workshop—check each program page for details.',
    'footer.brand':
