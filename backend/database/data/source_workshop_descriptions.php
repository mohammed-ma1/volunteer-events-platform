...
return [
    ...
    'ms-w-006' => [
        ...
        'description_ar' => 'عيش التجربة لتفهم نفسك وتواجه مخاوفك وتبني مسارك بثقة ووضوح.',
        'description_en' => 'A practical, hands-on session on From Zero to Hero via Zoom.',
        'category' => 'professional',
    ...
    'ms-w-026' => [
        'title' => 'أول دقيقة تصنع الفرق: هندسة الإنطباع الأول',
        'title_en' => 'The first minute makes the difference',
        'description_ar' => 'هندسة الانطباع الأول والتحكم في حضورك خلال أول دقيقة من أي لقاء.',
        'description_en' => 'A practical, hands-on session on The first minute makes the difference via Zoom.',
        'category' => 'professional',
        'instructor' => 'مرزوق السعيد',
    ],
    'ms-w-028' => [
    ...
    'ms-w-038' => [
        'title' => 'إدارة الذات وتقليل الضغوط - كيف تستعيد زمام نفسك في 30 دقيقة',
        'title_en' => 'Self-management and stress reduction in 30 minutes',
        'description_ar' => 'تقنيات عملية لاستعادة التركيز والهدوء وإدارة الضغوط في دقائق.',
        'description_en' => 'A practical, hands-on session on Self-management and stress reduction in 30 minutes via Zoom.',
        'category' => 'personal',
        'instructor' => 'منال المسلم',
    ],
    'ms-w-039' => [
        'title' => 'منحوتات من الشمع',
        'title_en' => 'Wax Sculptures',
        'description_ar' => 'ورشة فنية لصناعة منحوتات من الشمع: الأدوات والخامات وخطوات التشكيل والتلوين.',
        'description_en' => 'A hands-on art workshop on crafting wax sculptures: tools, materials, shaping techniques, and finishing.',
        'category' => 'personal',
    ...
    'ms-w-044' => [
        'title' => 'الفنان والزمن: الرسم كتوثيق',
    ...
    'ms-w-065' => [
        'title' => 'فن تقديم الفعاليات: مهارات العريف المؤثر',
        'title_en' => 'The art of hosting events',
        'description_ar' => 'مهارات العريف المؤثر في تقديم الفعاليات وإدارة المنصة بثقة.',
        'description_en' => 'A practical, hands-on session on The art of hosting events via Zoom.',
        'category' => 'professional',
        'instructor' => 'مرزوق السعيد',
    ],
    'ms-w-066' => [
    ...
    'ms-w-076' => [
        ...
        'description_en' => 'A practical, hands-on session on Don\'t wait for the opportunity via Zoom.',
        'category' => 'personal',
    ...
    'ms-w-079' => [
        ...
        'description_en' => 'How to turn your skill or hobby into a profitable business: pricing, marketing, and landing your first customers.',
        'category' => 'professional',
    ...
    'ms-w-082' => [
        ...
        'description_en' => 'How to market and sell your skill to the right customers through digital channels at fair prices.',
        'category' => 'professional',
        'instructor' => 'م. الجازي العجمي',
    ],
    'ms-w-083' => [
    ...
    'ms-w-085' => [
        ...
        'description_en' => 'A practical, hands-on session on The independent filmmaker via Zoom.',
        'category' => 'personal',
        'instructor' => 'سالم الهاجري',
    ],
    'ms-w-086' => [
    ...
    'ms-w-092' => [
        ...
        'description_en' => 'A practical, hands-on session on Your golden version via Zoom.',
        'category' => 'professional',
        'instructor' => 'مرزوق السعيد',
    ],
    'ms-w-093' => [
    ...
    'ms-w-101' => [
        'title' => 'قوة القرار',
        'title_en' => 'The Power of Decision-Making',
        'description_ar' => 'ورشة تطبيقية لتعزيز مهارة اتخاذ القرار بثقة وفاعلية في مختلف المواقف.',
        'description_en' => 'A practical workshop to strengthen confident, effective decision-making across different situations.',
        'category' => 'personal',
        'instructor' => 'أشواق العنزي',
    ],
    'ms-w-102' => [
        'title' => 'أسرار المقابلة الشخصية',
        'title_en' => 'Job Interview Secrets',
        'description_ar' => 'أسرار وتقنيات النجاح في المقابلات الشخصية والتميّز أمام لجان التوظيف.',
        'description_en' => 'Secrets and techniques for succeeding in job interviews and standing out to hiring panels.',
        'category' => 'professional',
        'instructor' => 'سحر الشمري',
    ],
    'ms-w-103' => [
    ...
    'ms-w-104' => [
        'title' => 'فن كتابة السيرة الذاتية',
        'title_en' => 'The Art of CV Writing',
        'description_ar' => 'تعلّم كتابة سيرة ذاتية احترافية تبرز مهاراتك وتفتح لك أبواب الوظائف.',
        'description_en' => 'Learn to write a professional CV that highlights your skills and opens job opportunities.',
        'category' => 'professional',
        'instructor' => 'سحر الشمري',
    ],
    'ms-w-105' => [
        'title' => 'your first 90 days at work',
        'title_en' => 'Your First 90 Days at Work',
        'description_ar' => 'خطة عملية للنجاح في أول 90 يوماً في وظيفتك الجديدة وبناء انطباع قوي.',
    ...
    'ms-w-109' => [
        'title' => 'التخطيط نصف النجاح',
        'title_en' => 'Planning is Half the Success',
        'description_ar' => 'كيف يساعدك التخطيط الجيد على إنجاز أهدافك بكفاءة وتقليل العشوائية.',
        'description_en' => 'How good planning helps you achieve your goals efficiently and reduce randomness.',
        'category' => 'personal',
        'instructor' => 'فيصل الدويسان',
    ],
    'ms-w-110' => [
        'title' => 'التركيز والمشتتات',
        'title_en' => 'Focus and Distractions',
        'description_ar' => 'أدوات عملية لتعزيز التركيز والتعامل مع المشتتات في حياتك اليومية.',
        'description_en' => 'Practical tools to boost focus and manage distractions in daily life.',
        'category' => 'personal',
        'instructor' => 'فيصل الدويسان',
    ],
    'ms-w-111' => [
        'title' => 'غير الكود',
        'title_en' => 'Change the Code',
        'description_ar' => 'ورشة تفاعلية لتغيير أنماط التفكير وكسر القوالب نحو نتائج أفضل.',
        'description_en' => 'An interactive workshop on changing thinking patterns and breaking molds toward better results.',
        'category' => 'professional',
        'instructor' => 'أبرار العدواني',
    ],
    'ms-w-112' => [
        'title' => 'Get it done not perfect',
        'title_en' => 'Get It Done, Not Perfect',
        'description_ar' => 'تغلّب على السعي للكمال وأنجز مهامك بفعالية دون تردد.',
        'description_en' => 'Overcome perfectionism and get your tasks done effectively without hesitation.',
        'category' => 'personal',
        'instructor' => 'فيصل الدويسان',
    ],
    'ms-w-113' => [
        'title' => 'واعي بمشاعري',
        'title_en' => 'Aware of My Feelings',
        'description_ar' => 'ورشة في الوعي العاطفي وفهم المشاعر وإدارتها بطريقة صحية.',
        'description_en' => 'A workshop on emotional awareness and understanding and managing feelings in a healthy way.',
        'category' => 'personal',
        'instructor' => 'سارة المنيس',
    ],
];
